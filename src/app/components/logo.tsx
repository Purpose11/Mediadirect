export const MedidirectAiLogo = ({ className = "" }: { className?: string }) => {
    return (
      ...
      >
        ...
        <text x="15" y="30" fontFamily="Arial" fontSize="14" fontWeight="bold" fill="white">
          MD
        </text>
  
        {/* Text elements as a single word - now black */}
        <text x="45" y="32" fontFamily="Arial" fontSize="20" fontWeight="bold" fill="black">
          Mediadirect
        </text>
        <text x="155" y="32" fontFamily="Arial" fontSize="20" fontWeight="bold" fill="black">
          Ai
        </text>
      </svg>
    )
